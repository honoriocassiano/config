...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(region ((,class (:background ,red :foreground ,white))))
   `(highlight ((,class (:foreground ,fg3 :background ,bg1))))
	 `(hl-line ((,class (:background  ,bg1 :underline ,t))))
	 `(fringe ((,class (:background ,bg1 :foreground ,fg4))))
	 `(cursor ((,class (:background ,fg4))))
   `(isearch ((,class (:bold t :foreground ,warning :background ,bg3))))
   `(mode-line ((,class (:box (:line-width 1 :color nil) :bold t :foreground ,white :background ,red))))
   `(mode-line-inactive ((,class (:box (:line-width 1 :color nil :style pressed-button) :foreground ,var :background ,bg1 :weight normal))))
   `(mode-line-buffer-id ((,class (:bold t :foreground ,white :background ,unspec))))
	 `(mode-line-highlight ((,class (:foreground ,white :box nil :weight bold))))
   `(mode-line-emphasis ((,class (:foreground ,white))))
   ...
   `(completions-highlight ((,class (:underline t) )))
   `(icomplete-selected-match ((,class (:bold t :underline t))))
